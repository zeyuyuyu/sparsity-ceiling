...
cheapest cell in the table.

For a designer, the principle converts into a rule that can be applied before any
simulation: identify which side of the datapath --- recurrent state or emitted output ---
the workload's loss actually depends on, and spend the exactness budget there. The
