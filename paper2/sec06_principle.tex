...
\begin{tabular}{l r r}
\toprule
Workload & quantizer-alone $\Delta$bpc & state footprint \\
\midrule
char-LM                    & $-0.002$ & --- \\
copy $M{=}16$ (3 seeds)    & $+0.369$ & $1.000 \rightarrow 0.971 \pm 0.015$ \\
copy $M{=}32$ (3 seeds)    & $+0.385$ & $1.000 \rightarrow 0.976 \pm 0.005$ \\
\bottomrule
\end{tabular}
\end{center}

The identical hardware degradation is free on the statistical workload and costs
