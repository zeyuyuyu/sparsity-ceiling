...
stuck devices --- an on-silicon instance of analog imperfection charging quality. HPD addresses
the robustness side directly~\citep{hpd}; LMU-on-Braindrop is the earlier precedent. We treat this route in simulation, with the analog storage element's
