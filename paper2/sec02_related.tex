...
that the training itself confers robustness to analog noise, while IMSSA and HPD address the
robustness side directly~\citep{imssa,hpd}; LMU-on-Braindrop is the earlier precedent. We treat this route in simulation, with the analog storage element's
