...
recurrence in a digital datapath, optionally quantized. QS4D~\citep{qs4d} studies quantization of
diagonal SSMs for exactly this deployment target. Our \texttt{digital} variant is this route at
full precision, and it is the baseline every margin in this paper is measured against.
...
addresses the robustness side of the same substrate~\citep{imssa,hpd}, and LMU-on-Braindrop is
the earlier precedent. We treat this route in simulation, with the analog storage element's
